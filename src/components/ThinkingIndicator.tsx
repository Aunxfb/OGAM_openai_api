...
const styles = StyleSheet.create({
  ...
  thinkingText: {
    ...
    // measures the line with one typeface and draws it with another. iOS has Menlo, measures
    // and draws the same face, and read correctly - which is why this only showed on one
    // platform. The terminal type has no italic anyway.
    flexShrink: 1,
  },
});
