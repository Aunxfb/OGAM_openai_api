// Remote generation impls (extracted from generationServiceHelpers to keep it within the
// file-size budget). Each receives the GenerationService instance as `svc: any`.
